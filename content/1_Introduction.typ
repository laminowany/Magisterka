...
While there are many variants of the VRP, in this work we study the Capacitated Vehicle Routing Problem (CVRP), where each vehicle has a limited load capacity that cannot be exceeded. This variant combines relative simplicity with practical constraints and is representative of real-world routing problems @VRP_overview.
